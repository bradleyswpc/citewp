...
final class Repository {
	...
	public const META_KEY_FULL  = '_citewp_geo_score';       // serialized array
	public const META_KEY_TOTAL = '_citewp_geo_score_total'; // int (queryable)
	public const META_KEY_GRADE = '_citewp_geo_score_grade'; // red|orange|yellow|green
	public const META_KEY_TIME  = '_citewp_geo_score_time';  // mysql gmt timestamp
	...
	public function register(): void {
		...
		add_filter( 'citewp_recalculate_score', [ $this, 'recalculate' ] );
	}
	...
	private function scorable_types(): array {
		 ...
		 * @param string[] $types
		 */
		return apply_filters( 'citewp_scorable_post_types', self::SCORABLE_TYPES );
	}
}
