...
final class Menu {
		...
		<div class="citewp-aiso-page">
			...
			<nav class="citewp-aiso-rail" aria-label="<?php esc_attr_e( 'CiteWP sections', 'ai-search-optimizer' ); ?>">
				...
				<a href="https://github.com/bradleyswpc/citewp/discussions/categories/ideas" target="_blank" rel="noopener noreferrer" class="citewp-aiso-rail__feature-link">
					<?php esc_html_e( 'Request a Feature →', 'ai-search-optimizer' ); ?>
				</a>
			...
			<div class="citewp-aiso-kpi-card">
				...
				<div class="citewp-aiso-kpi-card__body">
					...
					<div class="citewp-aiso-kpi-card__caption">
						...
						echo esc_html( sprintf( __( 'out of 100 · %d scored', 'ai-search-optimizer' ), $scored_count ) ); ?>
					</div>
			...
			<div class="citewp-aiso-cs-table-wrap">
				...
				<div class="citewp-aiso-cs-table-head">
					...
					<form method="get" action="<?php echo esc_url( $base_url ); ?>">
						...
						?>
						<a href="<?php echo esc_url( $excl_toggle_url ); ?>" class="citewp-aiso-cs-excl-toggle <?php echo esc_attr( $excl_pill_cls ); ?>"><?php echo $hide_excluded ? esc_html__( 'Show excluded', 'ai-search-optimizer' ) : esc_html__( 'Hide excluded', 'ai-search-optimizer' ); ?></a>
						<input
							type="search"
							name="css"
						...
						<tr>
							<td class="citewp-aiso-cs-post-cell">
								...
								<div class="citewp-aiso-cs-post-info">
									<?php if ( $t_edit_url ) : ?>
									<a class="citewp-aiso-cs-post-info__title" href="<?php echo esc_url( $t_edit_url ); ?>" title="<?php echo esc_attr( get_the_title() ?: __( '(no title)', 'ai-search-optimizer' ) ); ?>"><?php echo esc_html( get_the_title() ?: __( '(no title)', 'ai-search-optimizer' ) ); ?></a>
									<?php else : ?>
									<span class="citewp-aiso-cs-post-info__title"><?php echo esc_html( get_the_title() ?: __( '(no title)', 'ai-search-optimizer' ) ); ?></span>
									<?php endif; ?>
									<div class="citewp-aiso-cs-post-info__pills">
										...
										<?php if ( $t_excluded ) : ?>
										<span class="citewp-aiso-cs-excluded-pill" title="<?php esc_attr_e( 'Excluded from llms.txt', 'ai-search-optimizer' ); ?>"><?php esc_html_e( 'Excluded', 'ai-search-optimizer' ); ?></span>
										<?php endif; ?>
									</div>
								</div>
							</td>
				...
				<div class="citewp-aiso-insights__body">
					<div class="citewp-aiso-insights__nested">
						...
						<div class="citewp-aiso-insights__nested-bottom">
							...
							<p class="citewp-aiso-cs-rec-empty"><?php esc_html_e( 'Every post and page is optimized. No recommendations right now — your content is hitting all the Cite Score signals. Nice work.', 'ai-search-optimizer' ); ?></p>
							<?php else : ?>
							<?php foreach ( $top_groups as $group ) :
								...
								if ( 'page' === $group_type ) {
									$type_noun = 1 === $affected_cnt ? __( 'Page', 'ai-search-optimizer' ) : __( 'Pages', 'ai-search-optimizer' );
								} else {
									$type_noun = 1 === $affected_cnt ? __( 'Post', 'ai-search-optimizer' ) : __( 'Posts', 'ai-search-optimizer' );
								}
								/* translators: 1: count, 2: type noun (Posts or Pages) */
								$btn_label = sprintf( __( 'View %1$d %2$s', 'ai-search-optimizer' ), $affected_cnt, $type_noun );
							?>
	...
	$cs_protip = apply_filters(
		'citewp_aiso/protip',
		__( 'Posts scoring 80+ are significantly more likely to be cited by AI engines. Use the AI Recommendations panel to find the highest-impact fixes for your lowest-scoring content.', 'ai-search-optimizer' ),
		'cite-score'
	);
	?>
	<div class="citewp-aiso-protip">
	...
	private function render_history_svg( array $datasets, int $days ): void {
		...
		if ( $sparse_point_count < 3 ) {
			...
			<div class="citewp-aiso-history-panel__empty">
				...
				<p class="citewp-aiso-history-panel__empty-text">
					<?php esc_html_e( 'Not enough history yet — daily scores accumulate over time.', 'ai-search-optimizer' ); ?>
				</p>
			</div>
			<?php
			return;
