...
final class DashboardWidget {
	...
	public function add_widget(): void {
		...
		wp_add_dashboard_widget(
			self::WIDGET_ID,
			__( 'CiteWP — Cite Score', 'citewp-ai-search-optimizer' ),
			[ $this, 'render' ]
		);
	}
		...
		<div class="citewp-aiso-widget">
			...
			<div class="citewp-aiso-widget__stats">
				<div class="citewp-aiso-stat">
					<span class="citewp-aiso-stat__label"><?php esc_html_e( 'Avg Cite Score', 'citewp-ai-search-optimizer' ); ?></span>
			...
			<div class="citewp-aiso-widget__section">
				<h4 class="citewp-aiso-widget__heading"><?php esc_html_e( 'Top AI Crawlers (Last 7 Days)', 'citewp-ai-search-optimizer' ); ?></h4>
			...
			<div class="citewp-aiso-widget__section">
				<h4 class="citewp-aiso-widget__heading"><?php esc_html_e( 'Lowest Cite Scores — Needs Attention', 'citewp-ai-search-optimizer' ); ?></h4>
				<ul class="citewp-aiso-list">
