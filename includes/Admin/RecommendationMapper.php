...
final class RecommendationMapper {
	...
	/**
	 * @var array<string, array{label: string, copy: string, category: string, anchor: string}>
	 */
	private const MAP = [
		'faq_schema_or_qa'   => [
		...
		'paragraph_chunks'   => [
			...
			'anchor'   => 'self-contained-passages',
		],
		'word_count'         => [
			'label'    => 'Word count',
			'category' => 'structure',
		...
		'audience_use_case'  => [
			...
			'anchor'   => 'defined-audience-use-case',
		],
		'author_byline'      => [
		...
		'featured_image'     => [
			...
			'anchor'   => 'featured-image-with-alt-text',
		],
	];

	/**
	 * @return array{label: string, copy: string, category: string, anchor: string}|null
	 */
	 ...
	 * @return array<string, array{label: string, copy: string, category: string, anchor: string}>
	 */
