...
$table = $wpdb->prefix . 'citewp_aiso_crawler_logs'; // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound -- Uninstall script; variables are local to this file's global scope.
...
delete_option( 'citewp_aiso_settings' );
delete_option( 'citewp_aiso_llms_settings' );
delete_option( 'citewp_aiso_db_version' );
...
$meta_keys = [ // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound -- Uninstall script; variables are local to this file's global scope.
	'_citewp_aiso_geo_score',
	'_citewp_aiso_geo_score_total',
	'_citewp_aiso_geo_score_grade',
	'_citewp_aiso_geo_score_time',
...
delete_transient( 'citewp_aiso_llms_short' );
delete_transient( 'citewp_aiso_llms_full' );

// Clear scheduled cleanup hook.
$next = wp_next_scheduled( 'citewp_aiso_daily_cleanup' ); // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound -- Uninstall script; variables are local to this file's global scope.
if ( $next ) {
	wp_unschedule_event( $next, 'citewp_aiso_daily_cleanup' );
}
